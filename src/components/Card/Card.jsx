      ...
      <div className="">
        ...
        >
          ...
          <div className="relative top-[0%] sm:w-[100%] h-[150px] sm:h-[87%] bg-[#1d204b] hover:bg-[#262956] rounded-xl z-[5]">
            ...
            <p className="text-white text-sm sm:px-[12.5%] sm:py-[7%] p-4 font-semibold">
              {data[index].title}
            </p>
            ...
            <div className="">
              <div className="text-white sm:w-[170px] mx-auto text-4xl my-[3%] grid grid-cols-2 sm:grid-cols-none">
                ...
                <div className="text-gray-600 sm:text-xs text-sm my-auto p-[10%] sm:px-0 py-3 text-end sm:text-start">
