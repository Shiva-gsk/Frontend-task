...
const Card = ({index}) => {
  ...
  return (
    <>
    <div className=''>
        <div className= {`absolute bg-[${color[index]}] w-[100%] sm:w-[29%] sm:h-[45%] max-h-600px text-3xl rounded-xl contain-content min-w-[120px] hover:scale-[101%]`} style={{ backgroundColor: color[index] }}>
            ...
            <div className='relative top-[0%] sm:w-[100%] h-[150px] sm:h-[87%] bg-[#1d204b] hover:bg-[#262956] rounded-xl z-[5]'>
                <div className='hover:cursor-pointer relative top-[20%] left-[75%] h-[7%] flex item-'>
                <svg width="21" height="5" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fill-rule="evenodd"/></svg>
                </div>
            <p className='text-white text-sm px-[5%] py-[7%]'>{data[index].title}</p>
            <div className='text-white w-[170px] mx-auto text-4xl my-[3%]'>{data[index].timeframes[item].current}hrs
            <div className='text-gray-600 text-xs my-1'>Last Week- {data[index].timeframes[item].previous}hrs</div>
