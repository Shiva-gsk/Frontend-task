...
const Card = ({index}) => {
  ...
  return (
    ...
    <section>
    <div className=''>
        <div className= {`absolute bg-[${color[index]}] w-[29%] h-[45%] text-3xl rounded-xl contain-content min-w-[120px] hover:scale-105`} style={{ backgroundColor: color[index] }}>
            ...
            <div className='relative top-[0%] w-[100%] h-[83%] bg-[#1d204b] hover:bg-[#262956] rounded-xl z-[5]'>
