...
const Card = ({index}) => {
  ...
  return (
    <>
    <div className=''>
        <div className= {`absolute bg-[${color[index]}] w-[100%] sm:w-[29%] sm:h-[45%] text-3xl rounded-xl contain-content min-w-[120px] hover:scale-[101%] overflow-hidden`} style={{ backgroundColor: color[index] }}>
            ...
            <div className='relative top-[0%] sm:w-[100%] sm:h-[87%] bg-[#1d204b] hover:bg-[#262956] rounded-xl z-[5]'>
