...
const Card = ({index}) => {
  ...
  return (
    ...
    <section>
    <div className=''>
        <div className= 'absolute bg-[#FF8B64] w-[29%] h-[45%] text-3xl rounded-xl contain-content min-w-[120px]'>
            ...
            <div className='relative top-[0%] w-[100%] h-[83%] bg-[#1D204B] rounded-xl z-[5]'>
                <div className='relative top-[20%] left-[75%]'>
                <svg width="21" height="5" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fill-rule="evenodd"/></svg>
                </div>
            <p className='text-white text-sm px-[5%] py-[7%]'>Work</p>
            <div className='text-white w-[170px] mx-auto text-4xl my-[3%]'>32hrs
