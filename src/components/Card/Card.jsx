...
const Card = ({index}) => {
  ...
  return (
    <>
    <div className=''>
        <div className= {`absolute bg-[${color[index]}] w-[100%] sm:w-[29%] sm:h-[45%] text-3xl rounded-xl contain-content min-w-[120px] hover:scale-[101%]`} style={{ backgroundColor: color[index] }}>
